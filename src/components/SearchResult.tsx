...
const SearchResult: React.FC<SearchProps> = ({
  ...
  const wordSearched =
    result.definitions.length > 0 ? result.definitions[0].word : "";
        ...
        <div key={index} className="search-result__block">
          ...
          <div className="search-result__usage">
            ...
            <ul className="search-result__list" key={uuidv4()}>
              <li className="search-result__item definition">
                {word.definition}
              </li>
              {word.example && (
                <li className="search-result__item example">{word.example}</li>
              )}
            </ul>
          </div>
        </div>
    ...
    <div className="search-result">
      <div className="wrapper">
        <div className="search-result__inner">
          ...
          {wordSearched && (
            <h2 className="search-result__heading">{wordSearched}</h2>
          )}
          {definitionList}
          {images && (
